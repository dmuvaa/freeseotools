...
export const metadata = {
    title: "Contact - Free SEO Tools",
    description: "Get in touch with the Free SEO Tools team. We're here to help with questions about AI brand visibility.",
}
            ...
            <section className="py-20">
                <div className="container mx-auto px-4 md:px-6 text-center max-w-3xl">
                    ...
                    <p className="text-lg md:text-xl text-[var(--text-muted)]">
                        Have questions about Free SEO Tools? We'd love to hear from you.
                    </p>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 md:px-6 max-w-5xl">
                    <div className="grid md:grid-cols-3 gap-8 mb-16">
                        <div className="p-6 rounded-xl border border-[var(--border)] bg-[var(--surface-1)] text-center">
                            ...
                            <a href="mailto:hello@freeseotools.com" className="text-[var(--primary)] hover:underline">
                                hello@freeseotools.com
                            </a>
                        </div>
                        <div className="p-6 rounded-xl border border-[var(--border)] bg-[var(--surface-1)] text-center">
