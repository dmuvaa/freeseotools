...
export const metadata = {
    title: "Documentation - Free SEO Tools",
    description: "Learn how to use Free SEO Tools to audit your brand's AI visibility. Getting started guides and help.",
}
    ...
    const sections = [
        {
            ...
            description: "Learn the basics of Free SEO Tools in 5 minutes",
            links: [
            ...
            <section className="py-20">
                <div className="container mx-auto px-4 md:px-6 text-center max-w-3xl">
                    ...
                    <p className="text-lg md:text-xl text-[var(--text-muted)] mb-8">
                        Everything you need to master Free SEO Tools and understand your brand's AI visibility.
                    </p>
                ...
                <div className="container mx-auto px-4 md:px-6 max-w-5xl">
                    <div className="rounded-xl bg-gradient-to-r from-[var(--primary)] to-[var(--accent)] p-6 md:p-8 text-white">
                        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                            <div>
                                <h2 className="text-xl font-bold mb-2">New to Free SEO Tools?</h2>
