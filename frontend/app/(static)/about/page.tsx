...
export const metadata = {
    title: "About BlitzGeo - AI Brand Visibility Platform",
    description: "Learn about BlitzGeo's mission to help brands understand and improve their visibility across AI search engines.",
}
            ...
            <section className="py-20 md:py-32">
                <div className="container mx-auto px-4 md:px-6 text-center max-w-3xl">
                    ...
                    <p className="text-lg md:text-xl text-[var(--text-muted)] mb-8">
                        BlitzGeo was founded with a simple mission: help brands understand how AI sees them,
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
                        <div>
                            ...
                            <p className="text-[var(--text-muted)]">
                                That's where BlitzGeo comes in. We audit your brand's presence across major AI models,
