...
export const metadata = {
    title: "Features - BlitzGeo AI Brand Visibility Platform",
    description: "Explore BlitzGeo's powerful features: Multi-Model Audits, AI Index Graph, Blitz Score, and Citation Tracking.",
}
        ...
        <main>
            ...
            <section className="py-20 bg-[var(--surface-1)]">
                <div className="container mx-auto px-4 md:px-6 max-w-4xl">
                    <h2 className="text-3xl font-bold text-center mb-12">BlitzGeo vs Traditional SEO Tools</h2>
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-[var(--border)]">
                                    <th className="text-left py-4 px-4 font-medium">Capability</th>
                                    <th className="text-center py-4 px-4 font-medium">BlitzGeo</th>
