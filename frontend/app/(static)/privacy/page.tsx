...
export const metadata = {
    title: "Privacy Policy - BlitzGeo",
    description: "BlitzGeo Privacy Policy - Learn how we collect, use, and protect your data.",
}
                ...
                <div className="space-y-8">
                    <section>
                        ...
                        <p className="text-[var(--text-muted)] mb-4">
                            BlitzGeo ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy
                    ...
                    <section>
                        ...
                        <p className="text-[var(--text-muted)]">
                            Email: <a href="mailto:privacy@blitzgeo.com" className="text-[var(--primary)] hover:underline">privacy@blitzgeo.com</a>
                        </p>
                    </section>
                </div>
            </div>
