...
import { Upload, Play, Trash2, Edit2, Pause, PlayCircle } from 'lucide-react'
...
export default function TrackingPage() {
    ...
    const fetchData = async () => {
        ...
        if (keywordsData) {
            const formatted = keywordsData.map((k: any) => ({
                ...k,
                project_name: k.projects?.name || 'Unknown Project'
            }))
    ...
    const handleRunNow = async (ids: string[]) => {
        ...
        try {
            ...
            // Refresh logic handled by caller or general refresh
            fetchData()
        } catch (e) {
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-text-muted mt-1">
                            Automated recurring audits for your top keywords
                        </p>
                    </div>
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="border-b border-border bg-surface-2/50">
                                ...
                                <th className="p-4 text-xs font-medium text-text-muted uppercase">Project</th>
                            ...
                            {keywords.length === 0 ? (
                                <tr>
                                    <td colSpan={6} className="p-8 text-center text-text-muted">
                                        No monitored keywords found. Add one to start tracking.
                                    </td>
                                </tr>
                            ) : (
                                keywords.map(keyword => (
                                    <tr key={keyword.id} className="border-b border-border hover:bg-surface-2/30 transition-colors">
                                        ...
                                        <td className="p-4 text-text-subtle">{keyword.project_name}</td>
                                        <td className="p-4">
            ...
            <AnimatePresence>
                {isAddModalOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                        ...
                        >
                            <h2 className="text-xl font-bold text-foreground mb-6">Track New Keywords</h2>
